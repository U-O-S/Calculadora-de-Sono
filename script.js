...
function hsono() {
    ...
    if ( horaAcordar > horaDormir && minDormir == minAcordar){

        min = 0
        sonototal = horaAcordar - horaDormir + " horas" 
    }
    ...
    if ( horaDormir < horaAcordar && minDormir > minAcordar){
        ...
        sonototal = (horaAcordar - horaDormir) - 1 + " horas e " + ((60 - minDormir) + minAcordar) + " minutos"
    }

    if ( horaDormir > horaAcordar && minDormir > minAcordar){

        sonototal = (horaAcordar + ( 24 - horaDormir) ) - 1 + " horas e " + ((60 - minDormir) + (minAcordar)) + " minutos"
    }
    ...
    if( horaDormir == horaAcordar && minDormir > minAcordar){
        ...
        sonototal = 23 + " horas e " + (minDormir - minAcordar) + " minutos"
    }
